...
Bleno.prototype.startAdvertisingWithManufacturerData = function (advertisementData, callback) {
    if (this.state !== 'poweredOn') {
        var error = new Error('Could not advertising scanning, state is ' + this.state + ' (not poweredOn)');
        ...
        this._bindings.startAdvertisingWithManufacturerData(advertisementData);
    }
};
